            ...
            <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body">
                    <div class="mb-3 mb-md-4 d-flex justify-content-between">
                        <div class="h3 mb-0">Ürün Ekle</div>
                    </div>
                    <div>
                        <form action="urun-ekle.php" method="post" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="" id="baslik" name="baslik" placeholder="Ürün Adı:" required>
                                </div>
                                <div class="form-group col-12 col-md-6">
                            ...
                            <div class="form-group col-12 col-md-6">
                                    ...
                                    <input type="file" name="resim[]" multiple required>
                                    <input type="aciklama" class="form-control" id="aciklama" name="aciklama" placeholder="Açıklama:" required>
                                </div>
                            </div>
                            <div class="form-row">
                            <div class="form-group col-12 col-md-6">
                                    <label for="fiyat">Ürün Fiyatı</label>
                                    <input type="fiyat" class="form-control" id="fiyat" name="fiyat" placeholder="Fiyat:" required>
                                </div>
                                <div class="form-group col-12 col-md-6">
                            ...
                            <button type="submit" class="btn btn-primary float-right" name="urun-ekle">Ekle</button>
                        </form>
                    </div>
                </div>
            </div>
